...
def analyze_answers(chat_id, call):
    ...
    if goal == "lose_weight":
        with (open("C:/Users/Александр/PycharmProjects/pythonProject4/TelegramBot/weight_loss_program.pdf", "rb") as pdf_file):
...
def send_program(call):
    program = call.data
    if program == "split":
        with open("C:/Users/Александр/PycharmProjects/pythonProject4/TelegramBot/split_training.pdf", "rb") as pdf_file:
            bot.send_document(call.message.chat.id, pdf_file, caption="Вот ваша программа сплит тренировки!")
    elif program == "fullbody":
        with open("C:/Users/Александр/PycharmProjects/pythonProject4/TelegramBot/fullbody_training.pdf",
                  "rb") as pdf_file:
